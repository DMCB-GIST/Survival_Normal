...
normal_screen_gene_idx = sort(pvec, index.return=T)$ix
...
tumor_screen_gene_idx = sort(pvec, index.return=T)$ix
kideny_tumor_screening_gene_list <- rownames(expr_normal)[screen_gene_idx]
